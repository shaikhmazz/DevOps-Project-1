# ALPHA — CI/CD DevOps Pipeline

A Google Photos-style image storage and gallery app (**React + Vite** frontend, **FastAPI** backend, **MongoDB** database) deployed end-to-end using a full DevOps pipeline:
